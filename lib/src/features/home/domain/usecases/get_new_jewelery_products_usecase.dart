...
class GetNewJeweleryProductsUseCase implements UseCase<List<Product>, void> {
  final NewProductsRepository _newProductsRepository;

  GetNewJeweleryProductsUseCase(this._newProductsRepository);

  @override
  Future<List<Product>> call({void params}) {
    return _newProductsRepository.getNewJewelery();
  }
}
