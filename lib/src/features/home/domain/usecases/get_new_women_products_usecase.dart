...
class GetNewWomenProductsUseCase implements UseCase<List<Product>, void> {
  final NewProductsRepository _newProductsRepository;

  GetNewWomenProductsUseCase(this._newProductsRepository);

  @override
  Future<List<Product>> call({void params}) {
    return _newProductsRepository.getNewWomen();
  }
}
